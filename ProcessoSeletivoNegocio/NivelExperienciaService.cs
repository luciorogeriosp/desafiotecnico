...
{
    public class NivelExperienciaService:IDisposable
    {
        private readonly INivelExperienciaDAL _instancia;

        public NivelExperienciaService()
        {
            _instancia = IoC<INivelExperienciaDAL>.ObterInstancia();
